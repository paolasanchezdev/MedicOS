// apps/web/src/modules/resources/components/DeleteResourceModal.tsx
import React, { useState } from 'react';
import { AlertTriangle, X } from 'lucide-react';
import type { ResourceWithMetrics } from '../types/resource.types';
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden border border-slate-200 p-6 space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            El fármaco <span className="font-mono font-semibold text-slate-700">{resource.code}</span> será marcado como inactivo. Esta acción no se puede completar si aún existen lotes con stock físico activo.
          </p>
        </div>
