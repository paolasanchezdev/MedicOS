// =========================================================================
// ARCHIVO: apps/web/src/portals/brigadista/pages/dashboard/resumen/components/TarjetaBienvenidaPromotor.tsx
// DESCRIPCIÓN: Banner institucional de bienvenida con estado de red e identidad.
// =========================================================================

import React from 'react';
import { ShieldCheck, RefreshCw, Calendar, Wifi, WifiOff } from 'lucide-react';

export interface TarjetaBienvenidaPromotorProps {
  firstName?: string;
  lastName?: string;
  role?: string;
  onRefresh: () => void;
...
export const TarjetaBienvenidaPromotor: React.FC<TarjetaBienvenidaPromotorProps> = ({
  firstName = 'Brigadista',
  lastName = 'Comunitario',
  role = 'BRIGADISTA',
  onRefresh,
  isRefreshing,
  isOnline = true,
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 flex-wrap">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold text-teal-100 shadow-2xs">
              ...
              <span>Centro Operativo &bull; Rol: {role}</span>
            </div>
