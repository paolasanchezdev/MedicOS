// apps/web/src/portals/admin/pages/establecimientos/clinicas/components/ClinicMetrics.tsx
...
interface ClinicMetricsProps {
  metrics: ClinicMetricsData;
}

export const ClinicMetrics: React.FC<ClinicMetricsProps> = ({ metrics }) => {
  return (
      ...
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs flex items-center justify-between">
        <div>
          ...
          <p className="text-2xl font-bold text-teal-700 mt-1">
            {metrics.nivelBasico} <span className="text-xs font-normal text-slate-400">(Nivel Básico)</span>
          </p>
        </div>
