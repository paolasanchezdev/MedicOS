// apps/web/src/portals/admin/pages/establecimientos/clinicas/components/ClinicFilters.tsx
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-xs border border-slate-200 flex flex-col md:flex-row gap-4 justify-between items-stretch md:items-center">
      <div className="flex-1 min-w-60 relative">
        ...
        <input
          type="text"
          placeholder="Buscar por nombre, código (ISSS-CC), municipio o dirección..."
          value={searchTerm}
