// apps/web/src/portals/admin/pages/recursos/equipos/components/EquiposFilters.tsx
import React from 'react';
import { Search, RotateCcw } from 'lucide-react';
import type { MedicalEquipmentFilters } from '../../../../../../modules/resources';

interface EquiposFiltersProps {
  filters: MedicalEquipmentFilters;
  onFilterChange: (newFilters: Partial<MedicalEquipmentFilters>) => void;
  onReset: () => void;
}

export const EquiposFilters: React.FC<EquiposFiltersProps> = ({
  filters,
  onFilterChange,
  onReset,
}) => {
  return (
    <div className="bg-white p-4 rounded-xl shadow-xs border border-slate-200 flex flex-col lg:flex-row gap-4 justify-between items-stretch lg:items-center">
      ...
      <div className="flex-1 min-w-60 relative">
        ...
        <input
          type="text"
          placeholder="Buscar por código (EQ-...), nombre, modelo o número de serie..."
      ...
      <div className="flex flex-wrap items-center gap-3">
        <select
          ...
          onChange={(e) => onFilterChange({ status: e.target.value as MedicalEquipmentFilters['status'] })}
        ...
        >
          ...
          <option value="OPERATIONAL">Operativo (Listo para brigada)</option>
