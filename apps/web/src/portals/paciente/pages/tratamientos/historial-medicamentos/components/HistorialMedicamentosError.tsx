// =========================================================================
// ARCHIVO: apps/web/src/portals/paciente/pages/tratamientos/historial-medicamentos/components/HistorialMedicamentosError.tsx
...
interface HistorialMedicamentosErrorProps {
  message: string;
  onRetry: () => void;
}

export const HistorialMedicamentosError: React.FC<HistorialMedicamentosErrorProps> = ({
  message,
  onRetry,
}) => {
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl p-10 text-center text-xs text-slate-500 shadow-2xs space-y-3.5 max-w-md mx-auto select-none">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 font-medium leading-relaxed">
          {message || 'No fue posible obtener tus medicamentos registrados en el sistema.'}
        </p>
      </div>
...
export default HistorialMedicamentosError;