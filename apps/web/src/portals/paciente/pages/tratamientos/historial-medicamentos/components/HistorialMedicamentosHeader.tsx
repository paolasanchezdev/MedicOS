// =========================================================================
// ARCHIVO: apps/web/src/portals/paciente/pages/tratamientos/historial-medicamentos/components/HistorialMedicamentosHeader.tsx
...
interface HistorialMedicamentosHeaderProps {
  totalCount: number;
}

export const HistorialMedicamentosHeader: React.FC<HistorialMedicamentosHeaderProps> = ({
  totalCount,
}) => {
  return (
      ...
      <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold text-teal-100 shadow-2xs">
            ...
            <span>Trayectoria Farmacoterapéutica &bull; MedicOS</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-teal-100/90 font-medium max-w-xl">
            Consulta los medicamentos y tratamientos farmacológicos indicados en tus atenciones clínicas.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 px-3.5 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-xs font-bold text-white shadow-2xs">
            ...
            <span className="font-normal text-teal-100">medicamento(s) registrado(s)</span>
          </div>
        </div>
      </div>
    </div>
...
export default HistorialMedicamentosHeader;