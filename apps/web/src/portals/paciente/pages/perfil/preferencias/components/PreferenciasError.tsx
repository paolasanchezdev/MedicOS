...
interface PreferenciasErrorProps {
  onRetry: () => void;
}

export const PreferenciasError: React.FC<PreferenciasErrorProps> = ({ onRetry }) => {
  return (
    <div className="rounded-2xl bg-white border border-rose-200 p-8 text-center space-y-3">
      ...
      <div className="space-y-1 max-w-sm mx-auto">
        ...
        <p className="text-xs text-slate-500">
          Ocurrió un inconveniente al consultar la configuración. Intenta nuevamente.
        </p>
      </div>
      <button
        type="button"
...
export default PreferenciasError;