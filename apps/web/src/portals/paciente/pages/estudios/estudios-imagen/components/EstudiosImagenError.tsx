// =========================================================================
// ARCHIVO: apps/web/src/portals/paciente/pages/estudios/estudios-imagen/components/EstudiosImagenError.tsx
...
interface EstudiosImagenErrorProps {
  message: string;
  onRetry: () => void;
}

export const EstudiosImagenError: React.FC<EstudiosImagenErrorProps> = ({
  message,
  onRetry,
}) => {
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl p-10 text-center text-xs text-slate-500 shadow-2xs space-y-3.5 max-w-md mx-auto select-none">
      ...
      <div className="space-y-1">
        <h2 className="text-base font-black text-slate-900">
          No pudimos cargar tus estudios de imagen
        </h2>
        <p className="text-xs text-slate-500 font-medium leading-relaxed">
          {message || 'No fue posible obtener los estudios de imagen registrados en este momento.'}
        </p>
      </div>
...
export default EstudiosImagenError;