// =========================================================================
// ARCHIVO: apps/web/src/portals/paciente/pages/estudios/estudios-imagen/components/EstudiosImagenHeader.tsx
...
interface EstudiosImagenHeaderProps {
  totalCount: number;
}

export const EstudiosImagenHeader: React.FC<EstudiosImagenHeaderProps> = ({
  totalCount,
}) => {
  return (
      ...
      <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold text-teal-100 shadow-2xs">
            ...
            <span>Radiodiagnóstico &bull; MedicOS</span>
          </div>

          <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-white">
            Estudios de Imagen Médica
          </h1>

          <p className="text-xs sm:text-sm text-teal-100/90 font-medium max-w-xl">
            Consulta tus estudios de radiografía, ultrasonido y resonancia con sus respectivos informes médicos oficiales.
          </p>
        </div>
...
export default EstudiosImagenHeader;