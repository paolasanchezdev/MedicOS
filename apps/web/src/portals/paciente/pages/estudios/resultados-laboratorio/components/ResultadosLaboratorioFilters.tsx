// =========================================================================
// ARCHIVO: apps/web/src/portals/paciente/pages/estudios/resultados-laboratorio/components/ResultadosLaboratorioFilters.tsx
// DESCRIPCIÓN: Barra compacta de búsqueda y filtros de estado y orden.
// =========================================================================

import React from 'react';
import { Search, X, SlidersHorizontal } from 'lucide-react';

interface ResultadosLaboratorioFiltersProps {
  search: string;
...
export const ResultadosLaboratorioFilters: React.FC<ResultadosLaboratorioFiltersProps> = ({
  search,
  onSearchChange,
  status,
  onStatusChange,
    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 p-2.5 shadow-2xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 select-none">
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          placeholder="Buscar estudio (ej. hemograma, glucosa, orina, perfil lipídico)..."
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-1.5">
          ...
          >
            ...
            <option value="COMPLETED">Resultado disponible</option>
...
export default ResultadosLaboratorioFilters;